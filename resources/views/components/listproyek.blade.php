...
<div class="bg-white shadow-md rounded-3xl justify-between p-6 mb-6">
    <div class="flex gap-7">
        ...
        <div class="mt-20 pb-2">
            <a href="{{ route('proyekdetail', $item->proyek) }}" class="text-xl bg-secondary hover:bg-primary text-center items-center text-white py-4 px-6 rounded-2xl font-semibold">Buka Proyek</a>
        </div>
    </div>
</div>
@endforeach
