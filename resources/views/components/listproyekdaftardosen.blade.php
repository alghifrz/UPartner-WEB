...
<div class="bg-white shadow-md rounded-3xl justify-between p-6 mb-6">
    <div class="flex gap-7">
        ...
        <div class="mt-16">
            <a href="{{ route('dosen.detailproyek', $item->proyek) }}" class="text-xl bg-secondary hover:bg-primary text-center items-center text-white py-4 px-6 rounded-2xl font-semibold">Lihat Detail Proyek</a>
        </div>
    </div>
</div>
@endforeach
