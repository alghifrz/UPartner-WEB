<x-dosen-app-layout :title="'Beranda Dosen'" :footer="$footer">
    <x-slot name="beranda">
        <div class="py-12 flex justify-between items-center max-w-[1500px] mx-auto mb-24 sm:px-6 md:px-6 lg:px-8">
            <div class="max-w-[800px]">
                ...
                <a href="{{ route('dosen.katalog') }}" class="text-white text-2xl font-semibold rounded-full bg-secondary hover:bg-primary py-4 px-10">{!! $dashboard['quotes']['button'] !!}</a>
            </div>
            <div class="z-1000">
    ...
    <div class="max-w-[1500px] mx-auto sm:px-6 md:px-6 lg:px-8 mt-12">
        <div class="flex justify-between items-center mb-6">
            <h2 class="text-4xl text-primary font-bold mb-8">{{ $dashboard['content']['judul'] }}</h2>
            <a href="{{ route('dosen.katalog') }}" class="text-md text-primary font-bold cursor-pointer hover:text-secondary mb-8 flex">
                {!! $dashboard['content']['show'] !!}
                <svg xmlns="http://www.w3.org/2000/svg" class="ml-0 h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div class="w-full col-span-full flex justify-center">
                <div class="w-full col-span-full flex justify-center flex-col items-center text-center">
                    ...
                    <p class="mb-6 text-lg text-gray-700">
                        Anda bisa membuat proyek baru dengan mengklik tombol di bawah ini
                    </p>
                    <a href="{{ route('dosen.buatproyek') }}" class="bg-secondary text-white py-2 px-6 rounded-lg font-semibold hover:bg-primary transition">
                        Buat Proyek
                    </a>
                </div>
            </div>
