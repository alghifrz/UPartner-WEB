            ...
            <div class="flex justify-center space-x-24">
                <div class="">
                    ...
                    <div class="mb-24 text-center">
                        ...
                        <p class="mt-3 text-primary font-medium text-3xl data-animate" data-animation="slide-up">{{ $user['nip'] }}</p>
                    ...
                    <div class="text-center data-animate" data-animation="slide-up">
                        <a href="{{ route('dosen.profile.editprofile') }}" class="bg-primary mt-12 rounded-full text-2xl md:text-3xl lg:text-4xl px-8 md:px-24 py-3 md:py-4 font-semibold text-white hover:bg-secondary hover:text-white rotate-3 data-animate" data-animation="slide-up">Ganti Profil</a>
                    </div>
                </div>
