                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-12">
                            ...
                            @foreach ($user->pendaftaran as $pendaftaran)
                                @if ($pendaftaran->status == 'Diterima')
                                    <a href="{{ route('dosen.proyekdetail', $pendaftaran->proyek) }}" class="bg-white rounded-[90px] shadow-lg justify-center hover:scale-105 hover:duration-500 hover:ease-in-out cursor-pointer">
                                        <div class="w-full h-52 rounded-t-[90px] mb-4" 
