        ...
        <div class="mx-6 flex-1 p-6">
            ...
            <div class="mb-16 mt-6">
                <ul class="flex space-x-12 text-lg">
                    <li>
                        <a href="/proyek/pendaftaran-proyek" 
                    ...
                    <li>
                        <a href="/proyek/pendaftaran-proyek?tab=DITERIMA"
                           class="py-4 px-4 font-semibold 
                    ...
                    <li>
                        <a href="/proyek/pendaftaran-proyek?tab=MENUNGGU"
                           class="py-4 px-4 font-semibold 
                    ...
                    <li>
                        <a href="/proyek/pendaftaran-proyek?tab=DITOLAK" 
                           class="py-4 px-4 font-semibold 
