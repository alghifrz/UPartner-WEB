<x-app-layout :title="'Detail Proyek'" :footer="$footer">
    ...
    <?php
        ...
        $total_tasks = $proyek->kegiatan->count(); // Total jumlah kegiatan
        $completed_tasks = $proyek->kegiatan->where('is_selesai', true)->count(); // Jumlah kegiatan yang selesai
    ...
    <div class="mt-6 px-12 mx-56 p-12 bg-white rounded-3xl flex flex-col border border-gray-300">
        ...
        <div class="flex flex-wrap gap-8 justify-center">
            ...
            <div class="w-60 rounded-lg flex flex-col items-center justify-center">
                <a href="{{ route('lihatprofildosen', $pm) }}" class="mb-4 rounded-full mx-auto w-[50px] sm:w-[100px] lg:w-[150px] xl:w-[200px] h-[50px] sm:h-[100px] lg:h-[150px] xl:h-[200px] bg-white shadow data-animate relative group" data-animation="slide-up" style="background-image: url('{{ asset($proyek->proyekManajer->photo) }}'); background-size: cover;">
